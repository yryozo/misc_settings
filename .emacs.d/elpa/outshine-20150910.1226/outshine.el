...
(defcustom outshine-org-style-global-cycling-when-argument-is-set-p nil
  "...#TODO"
  :group 'outshine
  :type 'boolean)
...
(outshine-define-key-with-fallback
 ...
 (or
  ...
  (and
   (equal arg '(4))
   outshine-org-style-global-cycling-when-argument-is-set-p)
